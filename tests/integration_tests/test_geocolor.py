...
full_integ_test_calls = [
    # NOTE ami and fci were not actually being tested regularly, so they are not
    # included here.  Those tests will still need to be updated to use tiny sectors,
    # and then added to this list of integration test calls.
    # goes_east, goes_west, and himawari have all been updated to use tiny sectors.
